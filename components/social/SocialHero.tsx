  ...
  return (
    <section className="relative mx-auto grid w-full max-w-6xl items-center gap-6 px-5 pb-5 pt-6 sm:px-8 md:min-h-[48vh] md:grid-cols-[0.96fr_1.04fr] md:gap-10 lg:min-h-[50vh] lg:px-10 lg:pt-8">
      <div className="order-2 text-center md:order-1 md:text-left">
        <p
          className="font-display text-[0.78rem] font-semibold uppercase tracking-[0.22em] text-blue-100/72"
          data-hero-reveal
        >
          AI Systems Architect
        </p>
        <h1
          className="mt-3 font-display text-[2.35rem] font-bold leading-[0.96] tracking-normal text-white min-[390px]:text-[2.75rem] sm:text-[4.4rem] lg:text-[5.85rem]"
          data-hero-reveal
        >
          Gary L.
        ...
        <p
          className="mx-auto mt-4 max-w-[20rem] text-[1.02rem] font-semibold leading-7 text-white md:mx-0 sm:max-w-none sm:text-[1.28rem] sm:leading-8"
          data-hero-reveal
        >
          Enter the system.
          <span className="block sm:inline"> Choose your next move.</span>
        </p>
        <p
          className="mx-auto mt-3 max-w-[17.5rem] text-sm leading-6 text-white/58 md:mx-0 sm:max-w-xl sm:text-base sm:leading-7"
          data-hero-reveal
        >
          <span className="block sm:inline">I build premium digital ecosystems</span>
          <span className="block sm:inline"> that turn ideas, brands, and businesses</span>
          <span className="block sm:inline"> into scalable infrastructure.</span>
        </p>
        <p
          className="mx-auto mt-3 max-w-[17.5rem] text-sm font-medium leading-6 text-white/42 md:mx-0 sm:max-w-xl"
          data-hero-reveal
        >
          <span className="block sm:inline">This is not a profile.</span>
          <span className="block sm:inline"> It is the entry point into a system built for impact.</span>
        </p>
      ...
      <div className="order-1 mx-auto w-full max-w-[14.2rem] md:order-2 md:max-w-[21rem] lg:max-w-[24rem]">
        <div ref={imageRef} className="relative aspect-[4/5]">
          <div className="absolute -inset-4 rounded-[2rem] bg-[conic-gradient(from_160deg,rgba(59,130,246,0.28),rgba(255,255,255,0.08),rgba(239,68,68,0.22),rgba(59,130,246,0.28))] opacity-70 blur-2xl" />
